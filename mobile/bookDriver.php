...
$transaction_num = getRefNumTransaction() + 1;
$response = array();
...
if ($row_trans[0] == 0) {
    $result = $mysqli_connect->query("INSERT INTO `tbl_transactions` (`ref_number`, `user_id`, `driver_id`, `starting_point`, `end_point`,`status`) VALUES ('$transaction_num', '$user_id', '$driver_user_id', '$d_latitude', '$d_longitude','0')");
